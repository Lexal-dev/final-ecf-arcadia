...
export default function Activity() {
  ...
  return (
    <section className="w-full flex flex-col gap-6 w-full md:w-2/3 lg:w-3/4 text-start px-2">
      <h3 className="text-4xl font-caption text-center mb-6">
        Les différentes activités du parc
      </h3>
      <p className="text-start text-lg md:text-xl mb-6">
        Arcadia vous propose une multitude d&apos;activités allant du visionnage
        des habitats au animaux qui y vivent. Aussi vous aurez accès à plusieurs
        services comprenant un train qui fait le tour du parc, un guide audio et
      ...
      <div className="w-full flex flex-col items-center mb-12">
        <div className="flex flex-col mb-6">
          <p className="text-lg md:text-xl mb-6">
            Pour accéder à nos habitats et animaux
          </p>
          <Link
            href="/habitats"
            className="text-center text-blue-300 hover:text-blue-400 hover:text-bold"
          >
            Clickez ici
          </Link>
        </div>
