  ...
  return (
    <main className="flex flex-col items-center w-full py-12">
      <Loading loading={loading}>
        <h1 className="text-2xl mb-6 font-caption font-bold">
        ...
        <div className=" w-full flex flex-col items-center">
          {services.length === 0 ? (
            ...
            <div className="overflow-auto max-h-[500px] w-full md:w-2/3">
              <table className="w-full text-secondary max-h-[500px] overflow-auto">
                <thead>
                ...
                <tbody>
                  {services.map((service) => (
                    <tr
                      key={service.id}
                      className="bg-foreground hover:bg-muted text-secondary w-full"
                    >
                      <td className="border-b px-4 py-2">{service.name}</td>
                      <td className="border-b px-4 py-2 break-words whitespace-normal max-w-[200px]">
                        {service.description}
                      </td>
                      <td className="border-b px-4 py-2">
                        <div className="flex justify-center gap-2">
                          <button
                            ...
                            className="text-white text-lg bg-red-500 hover:bg-red-600 p-2 rounded-md"
                          >
                            <MdDelete />
                          </button>
                          <button
                            onClick={() => openUpdateForm(service)}
                            className="text-white text-lg bg-yellow-500 hover:bg-yellow-600 rounded p-2"
                          >
                            <MdEdit />
                          </button>
                        </div>
