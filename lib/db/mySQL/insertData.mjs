...
const insertData = async () => {
    ...
    try {
        ...
        const insertHabitatsQuery = `
            ...
            ('Plaine', 'Plaine luxuriante', 'En bon état');
        `;
        ...
        const insertVetLogsQuery = `
            ...
            ('En parfaite santé', 'Chevreuil', 400, NOW(), NOW(), 1),
            ('Peut-être un début de maladie', 'Lapin', 500, NOW(), NOW(), 2),
            ('En parfaite santé', 'Poussin', 300, NOW(), NOW(), 3);
        `;
